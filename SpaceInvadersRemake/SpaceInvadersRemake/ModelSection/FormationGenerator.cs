    ...
    public static class FormationGenerator
    {
        ...
        public static Vector2[] CircleFormation
        {
            get
            {
                float ad = alienDistance;
                Vector2 bp = basePoint;
                Vector2[] formation = {new Vector2(bp.X - (4 * ad), bp.Y), new Vector2(bp.X - ad, bp.Y), new Vector2(bp.X, bp.Y), new Vector2(bp.X + ad, bp.Y), new Vector2(bp.X + (4 * ad), bp.Y),
                                          new Vector2(bp.X - (2 * ad), bp.Y + ad), new Vector2(bp.X - ad, bp.Y + ad), new Vector2(bp.X + ad, bp.Y + ad), new Vector2(bp.X + (2 * ad), bp.Y + ad),
                                          new Vector2(bp.X - (3 * ad), bp.Y + (2 * ad)), new Vector2(bp.X - (2 * ad), bp.Y + (2 * ad)), new Vector2(bp.X, bp.Y + (2 * ad)), new Vector2(bp.X + (2 * ad), bp.Y + (2 * ad)), new Vector2(bp.X + (3 * ad), bp.Y + (2 * ad)),
                                          new Vector2(bp.X - (2 * ad), bp.Y + (3 * ad)), new Vector2(bp.X - ad, bp.Y + (3 * ad)), new Vector2(bp.X + ad, bp.Y + (3 * ad)), new Vector2(bp.X + (2 * ad), bp.Y + (3 * ad)),
                                          new Vector2(bp.X - (4 * ad), bp.Y + (4 * ad)), new Vector2(bp.X - ad, bp.Y + (4 * ad)), new Vector2(bp.X, bp.Y + (4 * ad)), new Vector2(bp.X + ad, bp.Y + (4 * ad)), new Vector2(bp.X + (4 * ad), bp.Y + (4 * ad))};
                return formation;
            }
        }
